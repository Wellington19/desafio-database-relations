...
Aplicação para treinar o que foi aprendido no Node.js junto ao TypeScript, incluindo o uso de banco de dados com o TypeORM, e relacionamentos ManyToMany. Essa aplicação permite a criação de clientes, produtos e pedidos, onde o cliente pode gerar novos pedidos de compra de certos produtos, como um pequeno e-commerce, seguindo os requisitos propostos logo abaixo pelo desafio 9 do bootcamp GoStack da Rocketseat.
...
<h4 align="center">
  ⚠️ Antes de executar a aplicação você precisa ter o postgres rodando e um banco de dados com o nome "gostack_desafio09" para funcionar corretamente, olhar arquivo de configuração "ormconfig.json" ⚠️
</h4>

Para rodar a aplicação execute o comando `yarn dev:server` ou `npm run dev:server`

<h4 align="center">
  ⚠️ Caso retorne esse erro:
  ...
  CREATE EXTENSION IF NOT EXISTS "uuid-ossp"; ⚠️
</h4>
